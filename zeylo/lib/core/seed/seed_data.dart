...
class SeedData {
  ...
  static Future<void> _seedCategories(FirebaseFirestore firestore) async {
    ...
    for (var category in categories) {
      final docRef =
          firestore.collection('categories').doc(category['name'] as String?);
    ...
    final experiences = [
      {
        ...
        'description':
            'Explore the majestic Hanthana mountain range with stunning views of Kandy city. Our expert guides will lead you through ancient trails while sharing fascinating stories about the region\'s rich history and biodiversity.',
      ...
      },
      {
        ...
        'description':
            'Learn authentic Sri Lankan cooking from a professional instructor. Prepare traditional dishes like curry, lamprais, and hoppers in a home kitchen setting. Enjoy the meal you\'ve prepared with authentic stories and culture.',
        ...
        'availability': _generateAvailability(),
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 75))),
        'updatedAt': Timestamp.fromDate(DateTime.now()),
      },
      {
        'title': 'Street Food Tour',
        'description':
            'Explore Colombo\'s bustling street food scene with a local guide. Taste authentic, delicious street food at the best vendors while learning about the city\'s food culture and history.',
        ...
        'availability': _generateAvailability(),
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 50))),
        'updatedAt': Timestamp.fromDate(DateTime.now()),
      },
      {
        'title': 'Surfing Lessons',
        'description':
            'Learn to surf at Mirissa Beach with a professional instructor. Perfect for beginners and intermediate surfers. Enjoy warm waters, consistent waves, and a vibrant beach culture.',
        ...
        'availability': _generateAvailability(),
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 45))),
        'updatedAt': Timestamp.fromDate(DateTime.now()),
      },
      {
        ...
        'availability': _generateAvailability(),
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 55))),
        'updatedAt': Timestamp.fromDate(DateTime.now()),
      },
      {
        'title': 'Village Cooking Experience',
        'description':
            'Visit a traditional village and learn to cook authentic Sri Lankan cuisine from locals. Experience rural life, visit local markets, and prepare a traditional meal.',
        ...
        'availability': _generateAvailability(),
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 65))),
        'updatedAt': Timestamp.fromDate(DateTime.now()),
      },
      {
        'title': 'Photography Workshop',
        'description':
            'Master landscape and wildlife photography with a professional photographer. Learn composition, lighting, and post-processing techniques in stunning natural settings.',
        ...
        'requirements': [
          'DSLR or mirrorless camera (or smartphone acceptable)'
        ],
        'languages': ['English', 'Sinhala'],
        'averageRating': 4.9,
        'reviewCount': 16,
        ...
        'availability': _generateAvailability(),
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 70))),
        'updatedAt': Timestamp.fromDate(DateTime.now()),
      },
      {
        'title': 'Sunrise Watching',
        'description':
            'Wake up early to witness a spectacular sunrise from scenic viewpoints. A peaceful experience with expert guidance, perfect for photography or meditation.',
        ...
        'availability': _generateAvailability(),
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 40))),
        'updatedAt': Timestamp.fromDate(DateTime.now()),
      },
      {
        'title': 'Cultural Walk',
        'description':
            'Explore Colombo\'s rich cultural heritage with a knowledgeable local guide. Visit historic sites, ancient temples, colonial buildings, and learn about Sri Lanka\'s fascinating history.',
        ...
        'availability': _generateAvailability(),
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 80))),
        'updatedAt': Timestamp.fromDate(DateTime.now()),
      },
      {
        'title': 'Rooftop Party Night',
        'description':
            'Experience Colombo\'s vibrant nightlife at an exclusive rooftop venue. Dance, socialize, and enjoy the city skyline with local friends in a lively atmosphere.',
        ...
        'availability': _generateAvailability(),
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 35))),
        'updatedAt': Timestamp.fromDate(DateTime.now()),
      },
      {
        'title': 'Wildlife Safari',
        'description':
            'Explore Sri Lanka\'s incredible wildlife with an expert naturalist guide. Spot elephants, leopards, and exotic birds in their natural habitat in pristine national park settings.',
      ...
      },
      {
        ...
        'description':
            'Find peace and balance with a full-day yoga and meditation retreat. Practice with a certified instructor in serene surroundings and leave refreshed.',
      ...
      },
      {
        ...
        'description':
            'Experience Sri Lanka\'s famous tea plantations with an expert guide. Learn about tea production, pick tea leaves, and enjoy fresh tea in plantation settings.',
      ...
      },
      {
        ...
        'description':
            'Enjoy an evening of live traditional and contemporary music in an intimate venue. Experience authentic Sri Lankan music culture with drinks and good company.',
        ...
        'availability': _generateAvailability(),
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 42))),
        'updatedAt': Timestamp.fromDate(DateTime.now()),
      },
      {
        'title': 'Coastal Camping',
        'description':
            'Experience an unforgettable night camping on pristine Mirissa Beach. Enjoy campfire, stargazing, and the sound of waves. Perfect for adventure seekers.',
    ...
    final reviews = [
      {
        ...
        'rating': 5.0,
        'comment':
            'Absolutely amazing hiking experience! Hashan was an incredible guide with deep knowledge of the mountain and its history.',
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 20))),
      },
      {
        'experienceId': 'exp_1',
        'userId': 'user_2',
        ...
        'rating': 4.7,
        'comment':
            'Great views and well-organized hike. Would definitely do it again!',
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 18))),
      },
      {
        'experienceId': 'exp_2',
        'userId': 'user_3',
        ...
        'rating': 5.0,
        'comment':
            'Best cooking class I\'ve ever taken! Amali is passionate and the food was delicious. Highly recommended!',
        'createdAt':
      ...
      },
      {
        ...
        'rating': 4.9,
        'comment':
            'Learned so much about Sri Lankan cuisine. Home-cooked meal was authentic and delicious.',
        'createdAt':
      ...
      },
      {
        ...
        'rating': 4.8,
        'comment':
            'Amazing street food tour! Amali knows all the best vendors. Tasted authentic local flavors.',
        'createdAt':
      ...
      },
      {
        ...
        'rating': 4.9,
        'comment':
            'Finally learned to surf! Thenu is patient and encouraging. Perfect beginner experience.',
        'createdAt':
      ...
      },
      {
        ...
        'rating': 4.8,
        'comment':
            'Great instruction and beautiful beach setting. Can\'t wait to come back!',
        'createdAt':
      ...
      },
      {
        ...
        'rating': 5.0,
        'comment':
            'Sunset kayaking was magical! The guide was knowledgeable about wildlife and safety.',
        'createdAt':
      ...
      },
      {
        ...
        'rating': 4.8,
        'comment':
            'Authentic village experience! Learned about rural life while cooking traditional food.',
        'createdAt':
      ...
      },
      {
        ...
        'rating': 4.9,
        'comment':
            'Photography workshop was excellent! Shenuka\'s tips really improved my shots.',
        'createdAt':
      ...
      },
      {
        ...
        'rating': 4.7,
        'comment':
            'Magical sunrise experience! Worth waking up early for the views.',
        'createdAt':
      ...
      },
      {
        ...
        'rating': 4.8,
        'comment':
            'Sarah\'s cultural walk was informative and engaging. Loved learning about Colombo\'s history.',
        'createdAt':
      ...
      },
      {
        ...
        'rating': 4.6,
        'comment':
            'Great rooftop party venue! Amazing atmosphere and views of the city.',
        'createdAt':
      ...
      },
      {
        ...
        'rating': 4.9,
        'comment':
            'Wildlife safari was incredible! Saw leopards and elephants. Shenuka is an expert naturalist.',
        'createdAt':
      ...
      },
      {
        ...
        'rating': 4.9,
        'comment':
            'Best safari experience! Professional guides, great spotting opportunities, unforgettable.',
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 11))),
      },
      {
        'experienceId': 'exp_12',
        'userId': 'user_16',
        ...
        'rating': 4.9,
        'comment':
            'Yoga retreat was transformative. Peaceful setting and skilled instructor. Highly recommend!',
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 13))),
      },
      {
        'experienceId': 'exp_13',
        'userId': 'user_17',
        ...
        'rating': 4.8,
        'comment':
            'Tea plantation tour was fascinating! Learned so much about tea production and tasted fresh tea.',
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 14))),
      },
      {
        'experienceId': 'exp_14',
        'userId': 'user_18',
        ...
        'rating': 4.7,
        'comment':
            'Live music evening was fantastic! Great performers and amazing atmosphere.',
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 16))),
      },
      {
        'experienceId': 'exp_15',
        'userId': 'user_19',
        ...
        'rating': 4.9,
        'comment':
            'Coastal camping was the adventure of a lifetime! Thenu made it safe and fun.',
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 17))),
      },
      {
        'experienceId': 'exp_3',
        'userId': 'user_20',
        ...
        'rating': 4.8,
        'comment':
            'Fantastic food tour! Met locals and tried authentic street food from vendors.',
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 19))),
      },
      {
        'experienceId': 'exp_5',
        'userId': 'user_21',
        ...
        'rating': 4.9,
        'comment':
            'Kayaking at sunset was breathtaking! Professional guide, beautiful scenery.',
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 21))),
      },
      {
        'experienceId': 'exp_7',
        'userId': 'user_22',
        ...
        'rating': 4.9,
        'comment':
            'Photography workshop was the best! Learned professional techniques from an expert.',
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 22))),
      },
      {
        'experienceId': 'exp_9',
        'userId': 'user_23',
        ...
        'rating': 4.7,
        'comment':
            'Cultural walk with Sarah was enlightening. Great knowledge of local history.',
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 23))),
      },
      {
        'experienceId': 'exp_12',
        'userId': 'user_24',
        ...
        'rating': 4.9,
        'comment':
            'Yoga and meditation was exactly what I needed. Peaceful and rejuvenating.',
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 24))),
      },
      {
        'experienceId': 'exp_2',
        'userId': 'user_25',
        ...
        'rating': 4.8,
        'comment':
            'Cooking class was amazing! Learned authentic recipes and cooking techniques.',
        'createdAt':
      ...
      },
      {
        ...
        'rating': 4.8,
        'comment':
            'Village cooking experience was authentic and fun! Great cultural immersion.',
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 26))),
      },
      {
        'experienceId': 'exp_4',
        'userId': 'user_27',
        ...
        'rating': 4.8,
        'comment':
            'Surfing lessons were fantastic! Thenu is patient and encouraging for beginners.',
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 27))),
      },
      {
        'experienceId': 'exp_8',
        'userId': 'user_28',
        ...
        'rating': 4.8,
        'comment':
            'Sunrise watching was peaceful and beautiful. Worth the early wake-up!',
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 28))),
      },
      {
        'experienceId': 'exp_1',
        'userId': 'user_29',
        ...
        'rating': 4.7,
        'comment':
            'Mountain hiking was challenging but rewarding! Great guide and views.',
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 29))),
      },
      {
        'experienceId': 'exp_13',
        'userId': 'user_30',
        ...
        'rating': 4.8,
        'comment':
            'Tea plantation tour was educational and delicious! Loved the fresh tea tasting.',
        'createdAt':
            Timestamp.fromDate(DateTime.now().subtract(Duration(days: 30))),
      },
    ];

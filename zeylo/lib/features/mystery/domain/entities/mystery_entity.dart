...
class MysteryEntity {
  ...
  /// Price of the matched experience (if matched)
  final double? matchedPrice;

  /// Teaser description generated by AI
  final String? teaserDescription;

  /// Vibe of the mystery experience
  final String? vibe;

  /// Preparation notes for the user
  ...
  String toString() => 'MysteryEntity(id: $id, userId: $userId, location: $location, '
      ...
      'matchedPrice: $matchedPrice, teaserDescription: $teaserDescription, vibe: $vibe, preparationNotes: $preparationNotes, '
